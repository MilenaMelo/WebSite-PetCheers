  ...
  <div class="login">
    ...
    <div class="login-right">
      ...
      <form @submit.prevent="doLogin()" class="form-login">
        ...
        <button type="submit" class="btn btn-primary" v-on:click="doNone()" :disabled='loading'>
...
export default {
  ...
  methods: {
    // Async mMethod because has await the action of the auth()
    async doLogin () {
      this.loading = true
    ...
    doNone () {
      ...
      var element = document.getElementsByClassName('login-right').style.displlay = 'none'
    }
  }
}
</script>
