...
.login {
  background-image: url('../../assets/images/ativo6.png');
  background-size: 10%;
  display: flex;
...
.login-right, .login-left {
  ...
  height: 90%;
  border-radius: 10px;
  -webkit-box-shadow: 9px 7px 5px rgba(50, 50, 50, 0.15);
  -moz-box-shadow:    9px 7px 5px rgba(50, 50, 50, 0.50);
  box-shadow:         9px 7px 5px rgba(50, 50, 50, 0.12);
}
.form-login {
  width: 30vw;
  height: 50vh;
